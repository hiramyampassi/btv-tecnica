...
@section('cabecera','AGREGAR NUEVO EQUIPO')

@section('contenido')

		{!! Form::open(['route' => 'tecnica.nuevos.store', 'method' => 'POST']) !!}
		<div class="row">
		  <div class="col-md-6">
		  	<div class="form-inline">
				{!! Form::label('name','Asunto: ') !!}
				{!! Form::text('asunto',null,['class'=>'form-control','placeholder'=>'Asunto del formulario','required']) !!}
			</div>
		  </div>
		  <div class="col-md-6 text-right">
		  	<div class="form-inline">
				{!! Form::label('name','Codigo formulario') !!}
				{!! Form::text('codigo_form',$aaa,['class'=>'form-control text-right','placeholder'=>'00000','required','disabled']) !!}
			</div>
		  </div>
		</div><br>
		<div class="row">
		...
		<div class="row">
		   <div class="col-md-6">
		  	<div class="form-group">
				...
				{!! Form::text('marca',null,['class'=>'form-control','placeholder'=>'Ej: Dell, Acer, PHP, otro','required']) !!}
			</div>
			<div class="form-group">
				{!! Form::label('name','Partes del equipo') !!}
				{!! Form::text('componentes',null,['class'=>'form-control','placeholder'=>'Ej: Monitor, mouse, cable de poder, etc','required']) !!}
			</div>
		  </div>
		  <div class="col-md-6">
			<div class="form-group">
				{!! Form::label('name','Descripcion del equipo') !!}
				{!! Form::textarea('descripcion',null,['class'=>'form-control','rows'=>5,'placeholder'=>'Ej: Color cafe con franjas blancas, Disco duro de 1Tb con 8 Gb de RAM, etc.','required']) !!}
			</div>
		  </div>
		</div>
		...
		<div class="form-group">
			...
			<a href="{{ route('tecnica.nuevos.index') }}" class="btn btn-danger">Cancelar</a>
		</div>
