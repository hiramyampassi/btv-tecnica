...
@foreach($equipos as $equipo)
		<div class="row">
		  ...
		  <div class="col-md-6 text-right">
		  	<a href="{{ route('tecnica.recibidos.resend',$equipo->slug) }}" class="btn btn-primary" title="Enviar formulario a otra persona"><span class="glyphicon glyphicon-share"></span> Derivar</a>
		  	<a href="{{ route('tecnica.recibidos.print_form',$equipo->slug) }}" class="btn btn-success" title="Imprimir formulario completo"><span class="glyphicon glyphicon-print"></span></a>
		  </div>
		</div><br>
		...
		<div class="col-md-3">
		  ...
		  <div class="col-md-3">
		  	<div class="form-group">
				...
				{!! Form::text('ciudad_id',$equipo->c_nom.', '.$equipo->r_nom,['class'=>'form-control chosen-select','placeholder'=>'Seleccione el lugar de destino','readonly']) !!}
			</div>
		  </div>
		</div>
		...
		<div class="form-group text-center">
			<a href="{{ route('tecnica.recibidos.index') }}" class="btn btn-danger">Volver</a>
		</div>
@endforeach
